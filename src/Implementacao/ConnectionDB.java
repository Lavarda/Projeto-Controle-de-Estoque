...
public class ConnectionDB {
    ...
    private String URL = "jdbc:postgresql://127.0.0.1:5432/"; // url do servidor 192.168.4.204:5432
    private String USER = "postgres"; // usuario do db groupaps
    private String PASSWORD = "postgres"; // senha do usuario aps2019-1
    private String DATABASE = "produtos_aps"; // banco projeto_estoque
